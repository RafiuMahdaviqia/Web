<form action="{{ url('/prodi/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Import Data Prodi</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_prodi.xlsx') }}" class="btn btn-info btn-sm" download><i
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // jika sukses
                            ...
                            dataprodi.ajax.reload(); // reload datatable
                        } else { // jika error
                            $('.error-text').text('');
