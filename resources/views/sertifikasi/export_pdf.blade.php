            ...
            <tbody>
                @foreach ($sertifikasi as $item)
                    <tr>
                        ...
                        <td>{{ $item->nama_sertif }}</td>
                        <td>{{ $item->jenis_sertif }}</td>
                        <td class="text-right">{{ $item->tgl_mulai_sertif }}</td>
                        <td class="text-right">{{ $item->tgl_akhir_sertif }}</td>
                        <td>{{ $item->jenis_pendanaan_sertif }}</td>
                        <td>{{ $item->status }}</td>
                    </tr>
                @endforeach
            </tbody>
