<form action="{{ url('/bidang_minat/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_bidang_minat" id="file_bidang_minat" class="form-control" required>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // jika sukses
                            ...
                            databidang_minat.ajax.reload(); // reload datatable
                        } else { // jika error
                            $('.error-text').text('');
