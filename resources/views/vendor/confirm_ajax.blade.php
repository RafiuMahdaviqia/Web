                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="col-9">{{ $vendor->nama_vendor }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Alamat Vendor :</th>
                            <td class="col-9">{{ $vendor->alamat_vendor }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Jenis Vendor :</th>
                            <td class="col-9">{{ $vendor->jenis_vendor }}</td>
                        </tr>
                        <tr>
