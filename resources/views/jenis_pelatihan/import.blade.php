<form action="{{ url('/jenis_pelatihan/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_jenis_pelatihan.xlsx') }}" class="btn btn-info btn-sm" download><i
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // jika sukses
                            ...
                            tablejenis_pelatihan.ajax.reload(); // reload datatable
                        } else { // jika error
                            $('.error-text').text('');
